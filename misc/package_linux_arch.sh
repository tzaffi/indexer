...
docker run ${DOCKER_RUN_OPTS} \
    ...
    "${BUILD_IMAGE}" \
    bash -c "echo $USER; chown -R $USER /go/src/github.com/algorand/indexer && chown -R $USER /go/src/github.com/algorand/indexer/third_party/go-algorand && make ${MAKE_TARGET}"
